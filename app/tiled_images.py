...
def tiled_images(
    ...
    output_dir_path_full = get_full_path(output_dir_path, dir_name)
    create_dir(output_dir_path_full)
    info_txt_name = f'{dir_name}.txt'
        ...
        with open(info_path, "a", encoding="utf-8") as f:
            ...
            for y0 in y_starts:
                for x0 in x_starts:
                    ...
                    tile_filename = f"{dir_name}_{list_num}__{tile_index}___{x0}____{y0}_____{x1}______{y1}.png"
                    tile_path = get_full_path(output_dir_path_full, tile_filename)
    ...
    return output_dir_path_full, dir_name, info_path
