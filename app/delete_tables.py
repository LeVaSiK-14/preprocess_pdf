...
@measure_time
def delete_tables(png_lists_witout_lines_dir_path: str, png_lists_without_tables_path: str) -> None:
    
    png_dirs = get_dirs_from_dir(png_lists_witout_lines_dir_path)
    for png_dir in png_dirs:
        png_dir_path = get_full_path(png_lists_witout_lines_dir_path, png_dir)
