...
@measure_time
def delete_lines(png_dir_path: str, dir_name: str, png_lists_without_lines_path: str) -> tuple:
    png_lists = get_files_from_dir(png_dir_path)
    
    png_lists_without_lines_dir_path = get_full_path(png_lists_without_lines_path, dir_name)
    ...
    return png_lists_without_lines_dir_path, dir_name
